...
![图1-1 温水煮青蛙](http://qiniu.imolili.com/小书匠/1594180139615.jpg)
...
![图1-2操作系统内核](http://qiniu.imolili.com/小书匠/1594259672790.png)
...
![ 图1-3官网内核版本](http://qiniu.imolili.com/小书匠/1594259699438.png)
...
![图2-1 Linux行业薪资](http://qiniu.imolili.com/小书匠/1594259709072.png)
...
![图2-2 VMware Workstation图标](http://qiniu.imolili.com/小书匠/1594259717543.png)

2.  双击桌面VMware Workstation图标打开虚拟机软件，单击“创建新的虚拟机”，如图2-3所示：

![图2-3 VMware Workstation创建虚拟机](http://qiniu.imolili.com/小书匠/1594259720083.png)

3.  新建虚拟机向导，选择自定义（高级）（C）选项，如图2-4所示：

![图2-4 创建虚拟机向导](http://qiniu.imolili.com/小书匠/1594259723167.png)

4.  安装客户机操作系统，选择“稍后安装操作系统（S）”，如图2-5所示:

![图2-5 安装客户机操作系统](http://qiniu.imolili.com/小书匠/1594259728759.png)

5.  选择客户机操作系统，由于我们即将安装CentOS7操作系统，所以需要勾选“Linux（L）”，同时版本（V）选择“CentOS64位”，如图2-6所示：

![图2-6 操作系统版本](http://qiniu.imolili.com/小书匠/1594259758174.png)

6.  虚拟机内存设置，默认为1024MB，如图2-7所示：

![图2-7 虚拟机内存分配](http://qiniu.imolili.com/小书匠/1594259761302.png)

7.  选择虚拟机网络类型，此处选择-网络连接为-“使用桥接模式”，如图2-8所示：

![图2-8 虚拟机网络类型](http://qiniu.imolili.com/小书匠/1594259764881.png)

8.  指定磁盘容量，设置虚拟机硬盘大小为40GB，将虚拟磁盘拆分成多个文件，如下图2-9所示：

![图2-9设置虚拟机磁盘容量](http://qiniu.imolili.com/小书匠/1594259768476.png)

9.  虚拟机硬件资源创建完成，设备详情里面包括计算机常用设备，例如内存、处理器、硬盘、CD/DVD、网络适配器等，如图2-10所示：

![图2-10虚拟机裸机设备](http://qiniu.imolili.com/小书匠/1594259771008.png)

10.  将CentOS7 ISO系统镜像文件添加至虚拟机CD/DVD中，双击虚拟机“CD/DVD（IDE）自动检测”选项，选择CentOS-7-x86_64-DVD-1511.iso镜像文件，如图2-11所示：

![图2-11选择系统安装镜像](http://qiniu.imolili.com/小书匠/1594259774622.png)
...
![图2-12选择安装菜单](http://qiniu.imolili.com/小书匠/1594259777459.png)

2.  继续按Enter键启动安装进程，进入光盘检测，按Esc键跳过检测，如图2-13所示：

![图2-13跳过ISO镜像检测](http://qiniu.imolili.com/小书匠/1594259788928.png)

3.  CentOS7欢迎界面，选择安装过程中界面显示的语言，初学者可以选择“简体中文”或者默认English，如图2-14所示：

![图2-14选择安装过程语言](http://qiniu.imolili.com/小书匠/1594259836860.png)

4.  CentOS7 Installation Summary安装总览界面，如图2-15所示：

![图2-15 Installation Summary界面](http://qiniu.imolili.com/小书匠/1594259841124.png)

5.  选择“I will configure partioning.”，单击Done，如图2-16所示：

![图2-16 磁盘分区方式选择](http://qiniu.imolili.com/小书匠/1594259843907.png)

6.  下拉框选择“Standard Partition”，选择+号，创建分区，如图2-17所示：

![图2-17 磁盘分区类型选择](http://qiniu.imolili.com/小书匠/1594259852946.png)

7.  Linux操作系统分区与Windows操作系统分区C盘、D盘有很大区别，Liunx操作系统是采用树形的文件系统管理方式，所有的文件存储以/（根）开始，如图2-18所示。

![图2-18 Linux文件系统目录结构](http://qiniu.imolili.com/小书匠/1594259855420.png)
...
![图2-25 Login登录系统界面](http://qiniu.imolili.com/小书匠/1594259881903.png)
...
![图3-1 MBR分区表内容](http://qiniu.imolili.com/小书匠/1594259886730.png)
...
![图3-2 GPT分区表内容](http://qiniu.imolili.com/小书匠/1594259891353.png)
...
![图3-3 GRUB引导流程](http://qiniu.imolili.com/小书匠/1594259899683.png)
...
![图3-4 系统启动流程](http://qiniu.imolili.com/小书匠/1594259902925.png)
...
![图3-9 ISO7层模型与TCP/IP四层对比](http://qiniu.imolili.com/小书匠/1594259917570.png)

OSI模型与TCP/IP模型协议功能实现对照表，如图3-10所示：

![图3-10 ISO7层模型与TCP/IP层次功能对比](http://qiniu.imolili.com/小书匠/1594259939299.png)
...
![图3-11 IPV4与IPV6地址](http://qiniu.imolili.com/小书匠/1594259958900.png)
...
![图3-12 YUM安装net-tools工具](http://qiniu.imolili.com/小书匠/1594259963540.png)
...
![图3-13 ping命令返回值](http://qiniu.imolili.com/小书匠/1594259966889.png)
...
![图3-14 网卡配置ifnames设置](http://qiniu.imolili.com/小书匠/1594259971028.png)

2.  执行命令`grub2-mkconfig -o /boot/grub2/grub.cfg`，生成新的grub.cfg文件，如图3-15所示：
`grub2-mkconfig -o /boot/grub2/grub.cfg`

![图3-15 生成新的grub.cnf文件](http://qiniu.imolili.com/小书匠/1594259974109.png)

3.  重命名网卡名称，执行命令`mv ifcfg-eno16777736 ifcfg-eth0`，修改ifcfg-eth0文件中DEVICE= eno16777736为DEVICE=eth0，如图3-16所示：

![图3-16 重命名网卡名称](http://qiniu.imolili.com/小书匠/1594259977842.png)

4.  重启服务器，并验证网卡名称是否为eth0，Reboot完后，如图3-17所示：

![图3-17 验证网卡设备名称](http://qiniu.imolili.com/小书匠/1594259980263.png)
...
![图3-18 内核菜单选择界面](http://qiniu.imolili.com/小书匠/1594259985047.png)

2.  继续按e进入编辑模式，找到ro crashkernel=auto xxx项，将ro改成rw init=/sysroot/bin/sh，如图3-19所示：

![图3-19 内核编辑界面](http://qiniu.imolili.com/小书匠/1594259988328.png)

3.  修改为后如图3-20所示：

![图3-20 内核编辑界面](http://qiniu.imolili.com/小书匠/1594259990834.png)

4.  按ctrl+x按钮进入单用户模式，如图3-21所示：

![图3-21 进入系统单用户模式](http://qiniu.imolili.com/小书匠/1594259994953.png)

5.  执行命令chroot /sysroot访问系统，并使用passwd修改root密码，如图3-22所示：

![图3-22 修改ROOT用户密码](http://qiniu.imolili.com/小书匠/1594259997959.png)
...
![图3-23 创建autorelabel文件](http://qiniu.imolili.com/小书匠/1594260000099.png)
...
![图3-24 SecureCRT远程Linux服务器](http://qiniu.imolili.com/小书匠/1594260005415.png)

通过SecureCRT远程连接Linux服务器之后，会发现如图3-25所示界面，与服务器本地操作界面一样，在命令行可以执行命令，操作结果与在服务器现场操作是一样。

![图3-25 SecureCRT远程Linux服务器](http://qiniu.imolili.com/小书匠/1594260009295.png)
...
![图3-26 Linux目录树形结构](http://qiniu.imolili.com/小书匠/1594260013242.png)
...
如图4-1所示：
![图4-1 Linux cd命令操作](http://qiniu.imolili.com/小书匠/1594260023511.png)
...
![图4-2 pwd命令查看当前目录](http://qiniu.imolili.com/小书匠/1594260029823.png)
...
![图4-3 echo –e颜色打印](http://qiniu.imolili.com/小书匠/1594260033690.png)
...
![图4-4 vim与键盘位置对应关系](http://qiniu.imolili.com/小书匠/1594191006226.png)
...
![图5-1 Linux jfedu.net目录详细属性](http://qiniu.imolili.com/小书匠/1594260037712.png)
...
![图5-3 SecureCRT登录Linux系统界面](http://qiniu.imolili.com/小书匠/1594192280445.png)
...
![图6-1 创建jingfeng目录及文件](http://qiniu.imolili.com/小书匠/1594260043737.png)
...
![图6-2 tar备份jingfeng目录中文件](http://qiniu.imolili.com/小书匠/1594260046485.png)
...
![图6-3 tar增量备份jingfeng目录中文件](http://qiniu.imolili.com/小书匠/1594260052156.png)
...
![图6-4 zip对jingfeng目录打包备份](http://qiniu.imolili.com/小书匠/1594260058679.png)

2.  通过zip工具打包jingfeng文件夹中所有内容，排除部分文件，如图6-5所示：
`zip -rv jingfeng.zip \* -x jf1.txt zip -rv jingfeng.zip \* -x jf2.txt -x jf3.txt`

![图6-5 zip对jingfeng目录打包备份，排除部分文件](http://qiniu.imolili.com/小书匠/1594260062294.png)
...
![图6-6 unzip对jingfeng目录解压](http://qiniu.imolili.com/小书匠/1594260064612.png)
...
![图6-7 YUM 安装httpd软件](http://qiniu.imolili.com/小书匠/1594260794157.png)

2.  执行命令yum grouplist，检查groupinstall的软件组名，如图6-8所示：

![图6-8 YUM Grouplist显示组安装名称](http://qiniu.imolili.com/小书匠/1594260794160.png)

3.  执行命令yum groupinstall "GNOME Desktop" -y，安装Linux图像界面，如图6-9所示:

![图6-9 GNOME Desktop图像界面安装](http://qiniu.imolili.com/小书匠/1594260794163.png)

4.  执行命令yum install httpd php php-devel php-mysql mariadb mariadb-server -y，安装中小企业LAMP架构环境，如图6-10所示:

![图6-10 LAMP中小企业架构安装](http://qiniu.imolili.com/小书匠/1594260794167.png)

5.  执行命令yum remove ntpdate -y，卸载ntpdate软件包，如图6-11所示:

![图6-11 卸载NTPDATE软件](http://qiniu.imolili.com/小书匠/1594260794170.png)

6.  执行命令yum provides rz或者yum provides "\*/rz"，查找rz命令的提供者，如图6-12所示：

![图6-12 查找RZ命令的提供者](http://qiniu.imolili.com/小书匠/1594260794173.png)

7.  执行命令yum update -y，升级Linux所有可更新的软件包或Linux内核升级，如图6-13所示：

![图6-13 软件包升级或内核升级](http://qiniu.imolili.com/小书匠/1594260794177.png)
...
![](http://qiniu.imolili.com/小书匠/1594260794181.png)
...
![](http://qiniu.imolili.com/小书匠/1594260794185.png)

vim 修改/etc/yum.repos./xx.repo文件，在base段中加入如下指令：（优先级为1表示优先被查找，越大其反而被后续查找）

priority=1

![](http://qiniu.imolili.com/小书匠/1594260794188.png)

基于YUM安装ntpdate软件，测试已经优先从163源中查找；

![](http://qiniu.imolili.com/小书匠/1594260794191.png)
...
![图6-14 CentOS ISO镜像文件挂载](http://qiniu.imolili.com/小书匠/1594260794195.png)
...
![图6-15 YUM 安装Screen软件](http://qiniu.imolili.com/小书匠/1594260794199.png)
...
![图6-16 Createrepo生成repodata目录](http://qiniu.imolili.com/小书匠/1594260794202.png)
...
![图6-17 HTTP YUM源客户端验证](http://qiniu.imolili.com/小书匠/1594260794206.png)
...
![图6-18 CreateRepo update更新软件包](http://qiniu.imolili.com/小书匠/1594260794209.png)

3.  客户端YUM验证，安装NTFS-3G软件包，如图6-19所示：

![图6-19 YUM INSTALL NTFS-3G软件包](http://qiniu.imolili.com/小书匠/1594260794307.png)
...
![图6-20（a） Reposync获取外网YUM源软件包](http://qiniu.imolili.com/小书匠/1594260794310.png)

![图6-20（b） Reposync获取外网YUM源软件包](http://qiniu.imolili.com/小书匠/1594260794313.png)
...
![图8-2（a） FTP主动模式](http://qiniu.imolili.com/小书匠/e019992e9526d6aa93f07b712bb12b1f.jpg)

![图8-2（b） FTP被动模式](http://qiniu.imolili.com/小书匠/be065aae00cf56ca19cf8abbfc7fdf0b.jpg)
...
![图8-3 YUM安装Vsftpd服务端](http://qiniu.imolili.com/小书匠/1594260794404.png)
...
![图8-4 打印Vsftpd软件安装后路径](http://qiniu.imolili.com/小书匠/1594260794407.png)
...
![图8-5 匿名用户访问FTP默认目录](http://qiniu.imolili.com/小书匠/1594260794411.png)
...
![图8-6 匿名用户访问上传文件](http://qiniu.imolili.com/小书匠/1594260794414.png)
...
![图8-7（a） jfedu1用户登录FTP服务器](http://qiniu.imolili.com/小书匠/1594260794417.png)

![图8-7（b） jfedu1登录FTP服务器上传文件](http://qiniu.imolili.com/小书匠/1594260794420.png)
...
![图8-8（a） jfedu001虚拟用户登录FTP服务器](http://qiniu.imolili.com/小书匠/1594260794424.png)

![图8-8（b） jfedu001虚拟用户上传下载文件](http://qiniu.imolili.com/小书匠/1594260794427.png)
...
![图10-1 Apache2.2.32安装图解](http://qiniu.imolili.com/小书匠/1594260794431.png)
...
![图10-2（a） Apache启动及查看进程](http://qiniu.imolili.com/小书匠/1594196815364.png)

![图10-2（b） 浏览器访问Apache WEB服务器](http://qiniu.imolili.com/小书匠/1594260794435.png)
...
![图10-3 httpd.conf配置文件开启虚拟主机](http://qiniu.imolili.com/小书匠/1594260794438.png)
...
![图10-4 Windows主机Hosts配置](http://qiniu.imolili.com/小书匠/1594197008880.png)

5.  浏览器访问 `www.jf1.com`、`www.jf2.com`如图10-5（a）、10-5（b）所示，至此Apache基于多域名虚拟主机配置完毕，如果还需添加虚拟主机，直接拷贝其中一个虚拟主机配置、修改WEB发布目录即可：

![图10-5（a）](http://qiniu.imolili.com/小书匠/1594260794453.png)

![图10-5（b）](http://qiniu.imolili.com/小书匠/1594260794456.png)
...
![](http://qiniu.imolili.com/小书匠/1594198871034.png)

![图12-1 Apache+PHP mod工作原理](http://qiniu.imolili.com/小书匠/1594198878905.png)

PHP是一种适用于web开发的动态语言，PHP语言内核基于C语言实现包含大量组件的软件框架，是一种功能强大的解释型脚本语言。PHP底层运行机制如图12-2所示：

![图12-2 PHP底层处理机制](http://qiniu.imolili.com/小书匠/1594260794496.png)
...
![图12-3 LAMP源码编译整合](http://qiniu.imolili.com/小书匠/1594260794500.png)
...
![图12-4 Apache+PHP测试页面](http://qiniu.imolili.com/小书匠/1594260794550.png)
...
![图12-5 Discuz安装界面一](http://qiniu.imolili.com/小书匠/1594260794554.png)

进入如图12-6界面，数据库安装，如果不存在则需要新建数据库并授权。

![图12-6 Discuz安装界面二](http://qiniu.imolili.com/小书匠/1594260794557.png)
...
![图12-7 Discuz安装界面三](http://qiniu.imolili.com/小书匠/1594260794655.png)
...
![图12-8 LAMP+Redis架构流程图](http://qiniu.imolili.com/小书匠/1594260794659.jpg)
...
![图12-9 PHP Redis模块添加](http://qiniu.imolili.com/小书匠/1594260794662.png)
